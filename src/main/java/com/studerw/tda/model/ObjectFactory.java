 ...
 * generated in the com.studerw.tda.model package. <p>An ObjectFactory allows you to programatically
...
public class ObjectFactory {
  ...
  /**
   * Create a new ObjectFactory that can be used to createDefinition new instances of schema derived
   * classes for package: com.studerw.tda.model
   */
